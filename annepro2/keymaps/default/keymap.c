...
const uint16_t keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  */
  ...
  [_MO_1] = KEYMAP(
    ...
    KC_NO, CONSOLE_LOG, KC_VS_TERMINAL, KC_VS_PROJ_SEARCH, KC_VS_SEARCH, KC_AMETHYST_RELAUNCH, KC_PREV_TERMINAL, KC_VS_SUGGESTIONS, KC_UP, VS_SHOW_HOVER, KC_NO, KC_NO, KC_NO, KC_VS_DELETE_LINE,
