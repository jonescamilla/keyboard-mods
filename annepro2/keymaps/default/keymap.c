...
*/
 ...
 [_BASE_LAYER] = KEYMAP( /* Base */
    ...
    KC_LCTL, KC_LALT, KC_LGUI, KC_SPC, MO(_FN2_LAYER), KC_NO, KC_NO, KC_NO
),
  /*
  * Layer _FN1_LAYER
  * ,-----------------------------------------------------------------------------------------.
 ...
 [_FN1_LAYER] = KEYMAP( /* Base */
    ...
    KC_TRNS, KC_LSFT, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_LEFT, KC_DOWN, KC_RGHT, KC_MPLY, KC_TILD, KC_TRNS,
